...
public class DrawGrid {
    ...
    public DrawGrid(Player[] players, LayoutDetails ld, boolean hasAi, DrawMenu menu) {
        RoundButton rButton = new RoundButton(new ImageIcon(getClass().getResource("/images/replay.png")));
        ai = hasAi;
        ...
        // menu button
        JLabel menuLabel = new JLabel(new ImageIcon(getClass().getResource("/images/menu.png")));
        // exit button
        JLabel exitLabel = new JLabel(new ImageIcon(getClass().getResource("/images/exit.png")));
        jl1 = new JLabel("P1 Wins!");
        jl1.setVisible(false);
        jl2 = new JLabel("P2 Wins!");
        ...
        rButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    se.playBackGround("/sounds/mixkit-unlock-game-notification-253.wav");
...
//            System.out.println(x + " " + xSpot + " " + y + " "+ ySpot);
        ...
        JPanel JpanelFromJFrame(JFrame frame)
        {
